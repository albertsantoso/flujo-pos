    ...
    return (
        <>
            <div className="product-card w-[324px] h-[426px] rounded-xl bg-white">
                <div className="card-container p-8 flex flex-col h-full relative">
                    ...
                    <div className="product-description mt-auto mb-2">
                        <p className="font-medium text-sm text-neutral-500 line-clamp-2 w-[60%]">
                            {product_description}
                        </p>
                    </div>
